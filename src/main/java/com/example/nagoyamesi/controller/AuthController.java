...
import com.example.nagoyamesi.event.ResetEventPublisher;
import com.example.nagoyamesi.event.SignupEventPublisher;
import com.example.nagoyamesi.form.ResetForm;
...
public class AuthController {
    ...
    public AuthController(UserService userService, SignupEventPublisher signupEventPublisher, VerificationTokenService verificationTokenService, UserRepository userRepository, ResetEventPublisher resetEventPublisher) {        
